...
@Injectable()
export class FeatureEventPublisher {
    private eventHandlers: Map<string, ((event: IDomainEvent<string>) => Promise<void>)[]> = new Map();

    registerHandler(eventName: string, handler: (event: IDomainEvent<string>) => Promise<void>): void {
