...
export class StaffQueryHandler {
  ...
  private readonly staffGrowth = {
    [Period.WEEK]: async (orgId: string) =>
      this.staffRepo.orgStaffGrowthByWeek(orgId),
    [Period.MONTH]: async (orgId: string) =>
      this.staffRepo.orgStaffGrowthByMonth(orgId),
    [Period.DAY]: async (orgId: string) =>
      this.staffRepo.orgStaffGrowthByDay(orgId),
    [Period.YEAR]: async (orgId: string) =>
      this.staffRepo.orgStaffGrowthByYear(orgId),
  };
  ...
  @LogExecutionTime()
  async handleStaffsGrowthByOrgId(
    orgId: string,
    period?: string,
