...
import { CreateSubscriptionCommand, UpdateSubscriptionCommand, DeleteSubscriptionCommand } from '../../dtos/commands/subscription-cmd.dto';
...
export class SubscriptionCommandHandler {
  ...
  async handleCreate(command: CreateSubscriptionCommand): Promise<SubscriptionEntity> {
  ...
  async handleUpdate(command: UpdateSubscriptionCommand): Promise<SubscriptionEntity> {
