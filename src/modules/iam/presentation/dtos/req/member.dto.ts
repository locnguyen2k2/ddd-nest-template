...
export class CreateMemberDto {
    ...
    @ApiProperty({ enum: AccessControlStatus, example: AccessControlStatus.ACTIVE, required: false })
...
export class UpdateMemberDto {
    @ApiProperty({ enum: AccessControlStatus, example: AccessControlStatus.ACTIVE })
    @IsEnum(AccessControlStatus)
    @IsNotEmpty()
    status!: AccessControlStatus;
}
