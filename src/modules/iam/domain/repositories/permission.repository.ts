...
export interface IPermissionRepository {
    ...
    findByAction(action: string, organizationId?: string): Promise<PermissionEntity | null>;
    findAll(): Promise<PermissionEntity[]>;
    update(id: string, permission: PermissionEntity): Promise<PermissionEntity | null>;
